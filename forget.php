        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            if ($result->num_rows === 0) {
                ...
                $sendSmtpEmail = new SendSmtpEmail([
                    'to' => [['email' => $email]],
                    'sender' => ['email' => 'fnc2905@gmail.com', 'name' => 'HIGH DREAMS'], // must match verified sender
                    'subject' => 'Your OTP Code for Password Reset',
                    'htmlContent' => "<p>Hello!</p>
                    <p>Your One-Time Password (OTP) is:</p>
                    <h2 style='color:#000;'>$otp</h2>
                    <p>Enter this code to reset your password. It expires soon.</p>
                    <br><p>- HIGH DREAMS Team</p>",
                ]);
                ...
                try {
                    ...
                    echo "<script>alert('OTP sent to your email successfully!'); window.location.href='" . $_SERVER['PHP_SELF'] . "';</script>";
                    exit;
                } catch (Exception $e) {
                    echo "<script>alert('Failed to send OTP: " . addslashes($e->getMessage()) . "');</script>";
