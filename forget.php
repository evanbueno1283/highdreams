    ...
    if (isset($_POST['email']) && !isset($_POST['otp']) && !isset($_POST['new_password'])) {
        ...
        if ($result->num_rows === 0) {
            ...
            $config = Configuration::getDefaultConfiguration()
                ->setApiKey('api-key', getenv('eyJhcGlfa2V5IjoieGtleXNpYi04MTIzNjZkOWU1NmU1Yzc2N2Y2ZmRhYjBiODM2NTQzZWEyYmI2ODgzYjJhZTdhZjY5OGZmODc3YmJmN2NkYjY3LWMwUHc2Z2VCTUZWZ0J4V3gifQ=='));
